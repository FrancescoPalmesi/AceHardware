        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="Produto.php" style="font-weight: 600; color:black;">Cadastro
                            Produtos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">|</a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md">
                <form>
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label"><label class="text-danger">* </label>
                            Descrição Produto</label>
                        <input type="text" class="form-control" id="exampleInputPassword1">
                        <div id="nome" class="form-text">Digite a descrição do Produto</div>
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label"><label class="text-danger">* </label>
                            Categoria</label>
                        <input type="email" class="form-control" id="exampleInputPassword1">
                        <div id="nome" class="form-text">Digite a categoria do Produto.</div>
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label"><label class="text-danger">* </label>
                            Preço de Venda</label>
                        <input type="text" class="form-control" id="exampleInputPassword1">
                        <div id="nome" class="form-text">Digite o preço de venda.</div>
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label"><label class="text-danger">* </label>
                            Preço Unitario</label>
                        <input type="text" class="form-control" id="exampleInputPassword1">
                        <div id="nome" class="form-text">Digite o preço unitario.</div>
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label"><label class="text-danger">* </label>
                            Quantidade em Estoque</label>
                        <input type="text" class="form-control" id="exampleInputPassword1">
                        <div id="nome" class="form-text">Digite a quanridade em estoque.</div>
                    </div>
                    <button type="submit" class="btn-lg btn-outline-danger btn-block"> Salvar </button>
                </form>
            </div>
            <div class="col">
            </div>
