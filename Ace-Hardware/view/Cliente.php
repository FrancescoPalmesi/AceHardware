...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
          ...
          <a class="nav-link" href="Cliente.php" style="font-weight: 600; color:black;">Cadastro Clientes</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#">|</a>
          </li>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md">
        <form>
          <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label"><label class="text-danger">* </label> Nome</label> <input
              type="text" class="form-control" id="nome" name="nome">
            <div id="nome" class="form-text">Digite o nome do Cliente.</div>
          </div>
          <div class="mb-3">
            <label for="exampleInputPassword1" class="form-label"><label class="text-danger">* </label> CPF/CNPJ</label>
            <input type="text" class="form-control" id="exampleInputPassword1" name="CPF">
            <div id="nome" class="form-text">Digite o CPF/CNPJ do Cliente.</div>
          </div>
          <div class="mb-3">
            <label for="exampleInputPassword1" class="form-label"><label class="text-danger">* </label> Email</label>
            <input type="email" class="form-control" id="exampleInputPassword1" name="email">
            <div id="nome" class="form-text">Digite o E-MAIL do Cliente.</div>
          </div>
          <div class="mb-3">
            <label for="exampleInputPassword1" class="form-label"><label class="text-danger">* </label> Endereco</label>
            <input type="text" class="form-control" id="exampleInputPassword1" name="tel">
            <div id="nome" class="form-text">Digite o TELEFONE do Cliente.</div>
          </div>
          <div class="mb-3">
            <label for="exampleInputPassword1" class="form-label"><label class="text-danger">* </label> Cidade</label>
            <input type="text" class="form-control" id="exampleInputPassword1" name="endereco">
            <div id="nome" class="form-text">Digite o ENDEREÇO do Cliente.</div>
          </div>
          <button type="submit" class="btn-lg btn-outline-danger btn-block" name="botao" > Salvar </button>
        </form>
      </div>
      <div class="col">
      </div>
  ...
  include_once'../model/C_Clientes.php';

  $cliente = new C_Clientes();
